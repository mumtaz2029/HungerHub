...
HungerHub is a Java 21 Maven WAR web application built for Apache Tomcat 9. The project is presented as a multi-deployment DevOps project that demonstrates manual deployment, Jenkins Freestyle CI/CD, Jenkins Pipeline CI/CD, and automated artifact storage in an Amazon S3 bucket.
...
The main goal of this project is to implement and document multiple deployment strategies for a Java web application on Apache Tomcat:
...
This method documents the direct Tomcat deployment flow before the same application release process is automated through Jenkins.
